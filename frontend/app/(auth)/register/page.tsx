      ...
      <div className="w-full max-w-6xl bg-white rounded-2xl shadow-2xl overflow-hidden flex">
            ...
            <div className="space-y-4">
              <div className="relative">
                ...
                <p className="text-xl italic font-light text-gray-200 leading-relaxed pl-6">
                  Membaca adalah investasi terbaik untuk masa depan. Satu buku yang kau baca hari ini, akan membentuk siapa dirimu esok.
                </p>
              </div>
        ...
        <div className="w-full lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            ...
            <p className="text-gray-500 text-center mb-8">Join our Library community</p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-teal-600 hover:bg-teal-700 text-white font-medium py-3 px-4 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-6"
              >
